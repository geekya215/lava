...
public sealed interface Keywords
        permits Keywords.CAR, Keywords.CDR, Keywords.COND, Keywords.CONS, Keywords.DEF, Keywords.ELSE, Keywords.FN,
        Keywords.IF, Keywords.LIST, Keywords.PROG, Keywords.QUOTE {
